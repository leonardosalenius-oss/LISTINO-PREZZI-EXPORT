...
UI = {
    "it": {"title": "Listino Ortofrutta", "updated": "Aggiornato al", "unavailable": "Non disponibile", "footer": "Prezzi indicativi, franco Volla (NA), salvo conferma disponibilità.",
           ...
           "order_header": "Nuovo ordine dal listino", "order_subject": "Nuovo ordine", "not_configured": "Contatti per l'ordine non ancora configurati."},
    "en": {"title": "Fresh Produce Price List", "updated": "Updated on", "unavailable": "Not available", "footer": "Indicative prices, ex-works Volla (Naples, Italy), subject to availability confirmation.",
           ...
           "order_header": "New order from the price list", "order_subject": "New order", "not_configured": "Order contact details not configured yet."},
    "fr": {"title": "Liste de prix Fruits & Légumes", "updated": "Mis à jour le", "unavailable": "Indisponible", "footer": "Prix indicatifs, départ Volla (Naples, Italie), sous réserve de disponibilité.",
           ...
           "order_header": "Nouvelle commande depuis la liste de prix", "order_subject": "Nouvelle commande", "not_configured": "Coordonnées pour la commande pas encore configurées."},
    "es": {"title": "Lista de precios Frutas y Verduras", "updated": "Actualizado el", "unavailable": "No disponible", "footer": "Precios indicativos, salida Volla (Nápoles, Italia), sujeto a confirmación de disponibilidad.",
           ...
           "order_header": "Nuevo pedido desde la lista de precios", "order_subject": "Nuevo pedido", "not_configured": "Datos de contacto para el pedido aún no configurados."},
    "pl": {"title": "Cennik Owoców i Warzyw", "updated": "Zaktualizowano", "unavailable": "Niedostępne", "footer": "Ceny orientacyjne, loco Volla (Neapol, Włochy), z zastrzeżeniem dostępności.",
           ...
           "order_header": "Nowe zamówienie z cennika", "order_subject": "Nowe zamówienie", "not_configured": "Dane kontaktowe do zamówień nie zostały jeszcze skonfigurowane."},
    "el": {"title": "Τιμοκατάλογος Οπωροκηπευτικών", "updated": "Ενημερώθηκε στις", "unavailable": "Μη διαθέσιμο", "footer": "Ενδεικτικές τιμές, εκ Volla (Νάπολη, Ιταλία), με την επιφύλαξη διαθεσιμότητας.",
           ...
           "order_header": "Νέα παραγγελία από τον τιμοκατάλογο", "order_subject": "Νέα παραγγελία", "not_configured": "Τα στοιχεία επικοινωνίας για παραγγελίες δεν έχουν ρυθμιστεί ακόμα."},
    "pt": {"title": "Lista de Preços Hortofrutícolas", "updated": "Atualizado em", "unavailable": "Indisponível", "footer": "Preços indicativos, saída de Volla (Nápoles, Itália), sujeitos a confirmação de disponibilidade.",
           ...
           "order_header": "Novo pedido da lista de preços", "order_subject": "Novo pedido", "not_configured": "Contactos para pedidos ainda não configurados."},
}
...
def render_customer_view():
    ...
    for pid, qty in st.session_state.cart.items():
        if qty and qty > 0 and pid in products_by_id:
            ...
            cart_lines.append(f"- {name_label(p, lang)}: {qty} {unit_label(p['unita_base'], lang)}")
    ...
    order_body_preview = "\n".join(cart_lines)
    st.text_area(t["order_title"], order_body_preview, height=min(38 + 28 * len(cart_lines), 300), disabled=True, label_visibility="collapsed")
